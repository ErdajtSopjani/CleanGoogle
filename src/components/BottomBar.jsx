    ...
    return (
        <div className="absolute bottom-0 bg-neutral-900 w-screen h-11 flex flex-row justify-between text-center items-center">
            <div className="mx-auto flex flex-row justify-center text-center items-center">
                ...
                <a className="hidden md:flex p-4 bg-transparent text-white text-xs md:text-base hover:underline" href="https://ads.google.com/intl/en_zz/home/">Advertising</a>
                <a className="hidden md:flex p-4 bg-transparent text-white text-xs md:text-base hover:underline" href="https://www.google.com/services/">Business</a>
            ...
            <div className="mx-auto flex flex-row justify-center text-center items-center">
                ...
                <a className="hidden md:flex p-4 bg-transparent text-white text-xs md:text-base hover:underline" href="https://policies.google.com/terms">Terms</a>
                <a className="hidden md:flex p-4 bg-transparent text-white text-xs md:text-base hover:underline" href="https://github.com/ErdajtSopjani/CleanGoogle">Settings</a>
            </div>
        </div>
